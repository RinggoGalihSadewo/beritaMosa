  ...
  <div class="banner-top-thumb-wrap">
    <div class="d-lg-flex justify-content-between align-items-center">
      <div class="d-flex justify-content-between  mb-3 mb-lg-0">
        <div>
          <img
            src="/images/dashboard/star-magazine-1.jpg"
            alt="thumb"
      ...
      <div class="d-flex justify-content-between mb-3 mb-lg-0">
        <div>
          <img
            src="/images/dashboard/star-magazine-2.jpg"
            alt="thumb"
            class="banner-top-thumb"
          />
        </div>
      ...
      <div class="d-flex justify-content-between mb-3 mb-lg-0">
        <div>
          <img
            src="/images/dashboard/star-magazine-3.jpg"
            alt="thumb"
            class="banner-top-thumb"
          />
        </div>
      ...
      <div class="d-flex justify-content-between mb-3 mb-lg-0">
        <div>
          <img
            src="/images/dashboard/star-magazine-4.jpg"
            alt="thumb"
            class="banner-top-thumb"
          />
        </div>
        ...
        <div class="item">
          <div class="carousel-content-wrapper mb-2">
            ...
            <div class="carousel-image">
              <img src="/images/dashboard/banner.jpg" alt="" />
            </div>
          </div>
        </div>
        <div class="item">
          <div class="carousel-content-wrapper mb-2">
            ...
            <div class="carousel-image">
              <img src="/images/dashboard/banner_1.jpg" alt="" />
            </div>
          </div>
        </div>
        <div class="item">
          <div class="carousel-content-wrapper mb-2">
            ...
            <div class="carousel-image">
              <img src="/images/dashboard/banner_2.jpg" alt="" />
            </div>
          </div>
        </div>
        <div class="item">
          <div class="carousel-content-wrapper mb-2">
            ...
            <div class="carousel-image">
              <img src="/images/dashboard/banner_3.jpg" alt="" />
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="row">
        ...
        <div class="col-sm-6">
          <div class="py-3 border-bottom">
            <div class="d-flex align-items-center pb-2">
              <img
                src="/images/dashboard/Profile_2.jpg"
                class="img-xs img-rounded mr-2"
                alt="thumb"
              />
      ...
      <div class="row">
        ...
        <div class="col-sm-6">
          <div class="pt-3 pb-4 border-bottom">
            <div class="d-flex align-items-center pb-2">
              <img
                src="/images/dashboard/Profile_4.jpg"
                class="img-xs img-rounded mr-2"
                alt="thumb"
              />
      ...
      <div class="row">
        <div class="col-sm-6">
          <div class="pt-4 pb-4">
            <div class="d-flex align-items-center pb-2">
              <img
                src="/images/dashboard/Profile_5.jpg"
                class="img-xs img-rounded mr-2"
                alt="thumb"
              />
        ...
        <div class="col-sm-6">
          <div class="pt-3 pb-4">
            <div class="d-flex align-items-center pb-2">
              <img
                src="/images/dashboard/Profile_6.jpg"
                class="img-xs img-rounded mr-2"
                alt="thumb"
              />
    ...
    <div class="row">
      <div class="col-lg-3 col-sm-6 grid-margin mb-5 mb-sm-2">
        <div class="position-relative image-hover">
          <img
            src="/images/dashboard/travel.jpg"
            class="img-fluid"
            alt="world-news"
          />
      ...
      <div class="col-lg-3 col-sm-6 mb-5 mb-sm-2">
        <div class="position-relative image-hover">
          <img
            src="/images/dashboard/business.jpg"
            class="img-fluid"
            alt="world-news"
          />
      ...
      <div class="col-lg-6  mb-5 mb-sm-2">
        <div class="row">
          <div class="col-sm-6  mb-5 mb-sm-2">
            <div class="position-relative image-hover">
              <img
                src="/images/dashboard/star-magazine-5.jpg"
                class="img-fluid"
                alt="world-news"
              />
          ...
          <div class="col-sm-6  mb-5 mb-sm-2">
            <div class="position-relative image-hover">
              <img
                src="/images/dashboard/star-magazine-6.jpg"
                class="img-fluid"
                alt="world-news"
              />
              <span class="thumb-title">TRAVEL</span>
        ...
        <div class="row mt-3">
          <div class="col-sm-6  mb-5 mb-sm-2">
            <div class="position-relative image-hover">
              <img
                src="/images/dashboard/star-magazine-7.jpg"
                class="img-fluid"
                alt="world-news"
              />
              <span class="thumb-title">POLITICS</span>
          ...
          <div class="col-sm-6">
            <div class="position-relative image-hover">
              <img
                src="/images/dashboard/star-magazine-8.jpg"
                class="img-fluid"
                alt="world-news"
              />
              <span class="thumb-title">TRAVEL</span>
